...
const STATUS_LABEL: Record<string, { text: string; cls: string }> = {
  sent:               { text: 'Aguardando sua resposta',      cls: 'bg-blue-100 text-blue-800' },
  revision_requested: { text: 'Revisão solicitada',           cls: 'bg-amber-100 text-amber-800' },
  awaiting_payment:   { text: 'Aguardando pagamento',         cls: 'bg-orange-100 text-orange-800' },
  paid:               { text: 'Pago',                         cls: 'bg-green-100 text-green-800' },
  cancelled:          { text: 'Cancelado',                    cls: 'bg-red-100 text-red-800' },
  draft:              { text: 'Rascunho',                     cls: 'bg-gray-100 text-gray-800' },
}
