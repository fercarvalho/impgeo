                ...
                {form.selectedServices.length > 0 && (
                  <div className="mt-2 p-2 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>Valor calculado:</strong> R$ {(calculateServicesValue(form.selectedServices)).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </p>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl shadow-2xl border border-gray-200">
            ...
            {form.selectedServices.length > 0 && (
              <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Valor total:</strong> R$ {(calculateServicesValue(form.selectedServices)).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  {form.selectedServices.length} serviço(s) selecionado(s)
                </p>
