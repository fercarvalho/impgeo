                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <ResponsiveContainer width="100%" height={250}>
                            <BarChart data={[{name: item.nome, valor: item.valor}]}> 
                              ...
                              <XAxis dataKey="name" />
                              <YAxis />
                              <Tooltip formatter={(value: any) => [`R$ ${(value).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 'Projeto']} />
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span className="font-bold text-green-800 text-lg ml-4 text-right">
                      R$ {(totalVendasCategoria).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </span>
                  </div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <ResponsiveContainer width="100%" height={250}>
                            <BarChart data={[{name: item.nome, valor: item.valor}]}> 
                              ...
                              <XAxis dataKey="name" />
                              <YAxis />
                              <Tooltip formatter={(value: any) => [`R$ ${(value).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, 'Serviço']} />
                              <Bar dataKey="valor" fill={item.cor} />
                            </BarChart>
                          </ResponsiveContainer>
                        </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span className="font-bold text-blue-800 text-sm ml-3 text-right">
                      R$ {(totalVendasProduto).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </span>
                  </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-4 bg-red-50 rounded-xl">
              ...
              <p className="text-xl font-bold text-red-600">R$ {(totalDespesas).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </div>
            <div className={`text-center p-4 rounded-xl ${lucroLiquido >= 0 ? 'bg-green-50' : 'bg-red-50'}`}>
              ...
              <p className={`text-xl font-bold ${lucroLiquido >= 0 ? 'text-green-600' : 'text-red-600'}`}>R$ {(lucroLiquido).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
              <div className={`mt-2 p-2 rounded-lg ${lucroLiquido >= 0 ? 'bg-green-100' : 'bg-red-100'}`}>
                <p className={`text-xs font-bold ${lucroLiquido >= 0 ? 'text-green-600' : 'text-red-600'}`}>Margem: {totalVendasCategoria > 0 ? ((lucroLiquido / totalVendasCategoria) * 100).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0,00'}%</p>
              </div>
            </div>
            <div className={`text-center p-4 rounded-xl ${lucroLiquido >= 0 ? 'bg-green-50' : 'bg-red-50'}`}>
