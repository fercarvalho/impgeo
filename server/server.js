...
app.post('/api/tasks/claim-bulk', requireModulePermission('tarefas_gerenciamento', 'edit'), async (req, res) => {
  try {
...
app.post('/api/tasks/:taskId/uncomplete', requireModulePermission('tarefas_gerenciamento', 'edit'), async (req, res) => {
  try {
